# -*- coding: utf-8 -*-
"""
Created on Sun May 24 12:48:22 2020
...
#converting the data into array with users in rows ans movies in columns
def convert(data):
    new_data=[]
...
#converting the ratings into binary 0(Not liked) and 1 (Liked)
